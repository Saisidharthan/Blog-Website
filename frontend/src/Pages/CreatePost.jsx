// import { MdCross } from "react-icons/md"
            ...
            <form className="w-full flex flex-col space-y-4 md:space-y-8 mt-4">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center space-x-4 md:space-x-8">
                        <input value={cat} onChange={(s)=>setCat(s.target.value)} className="px-4 py-2 " placeholder="Enter the post category" type="text"/>
                    ...
                    <div key={i} className="flex justify-center items-center space-x-2 mr-4 bg-gray-200 px-2 py-1 rounded-md">
                        <p>{c}</p>
{/* doubt  */}          <p onClick={deleteCategory} className="text-white bg-black rounded-full cursor-pointer "><RxCross2/></p>
                    </div>
                    ))}
